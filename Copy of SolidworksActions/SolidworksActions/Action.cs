...
{   
    ...
    {
        protected SolidworksAction(String name, IDictionary<string, object> variables)
            : base(name, variables)
        { }
    ...
    {
        public OpenSolidWorksFile(IDictionary<string, object> v)
    ...
    {
        public SwInsertDesignTable(IDictionary<string, object> v)
    ...
    {
        public SetActiveSolidWorksConfig(IDictionary<String, Object> v)
    ...
    {
        public SetSwComponentConfig(IDictionary<String, Object> v)
    ...
    public class SetSwDimension : SolidworksAction
    {
        ...
        public SetSwDimension(IDictionary<String, Object> v)
    ...
    public class SetSwSuppressionState : SolidworksAction
    {
        ...
        public SetSwSuppressionState(IDictionary<String, Object> v)
    ...
    {
        public DeleteSwItem(IDictionary<String, Object> v)
            : base("Delete Item", v)
        { }
    ...
    {
        public DeleteInactiveSwConfigurations(IDictionary<String, Object> v)
    ...
    {
        public DeleteInactiveSwComponents(IDictionary<String, Object> v)
    ...
    {
        public SaveSolidWorks(IDictionary<String, Object> v)
            : base("Save", v)
        { }
    ...
    {
        public SolidWorksSaveAs(IDictionary<String, Object> v)
                : base("Save As", v)
        { }
    ...
    {
        public CloseActiveSwDoc(IDictionary<String, Object> v)
    ...
    {
        public SwCloseAll(IDictionary<String, Object> v)
            : base("Close All", v)
        { }
    ...
    {
        public Quit(IDictionary<String, Object> v)
            : base("Quit", v)
        { }
    ...
    public class SolidWorksActionException : ActionException
    {
        public SolidWorksActionException(Action action)
            : base(String.Format("Error from Solidworks:\n{0}",
                String.Join("\n", SolidWorksWrapper.GetErrors())), action)
        { }
